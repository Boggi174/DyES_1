...
public class Pantalla_Inicio_Sesion2 implements ActionListener
{
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					IntelliJTheme.install( Pantalla_Inicio_Sesion2.class.getResourceAsStream("AA.json" ) );
					Pantalla_Inicio_Sesion2 window = new Pantalla_Inicio_Sesion2();
	 ...
	 * @return 
	 */
	public void launcherPantalla_Inicio_Sesion2() {
		Pantalla_Inicio_Sesion2 window = new Pantalla_Inicio_Sesion2();
